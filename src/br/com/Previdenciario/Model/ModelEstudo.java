package br.com.Previdenciario.Model;
...
public class ModelEstudo extends AbstractTableModel {

	private List<Estudo> dados;
	...
	public ModelEstudo() {
		dados = new ArrayList<Estudo>();

	}

	public void addRow(Estudo p) {
