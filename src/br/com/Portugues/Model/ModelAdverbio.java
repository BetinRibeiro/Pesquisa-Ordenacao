...
import br.com.Portugues.Bin.Adverbio;

public class ModelAdverbio extends AbstractTableModel {

	private List<Adverbio> dados;
	...
	public ModelAdverbio() {
		dados = new ArrayList<Adverbio>();

	}

	public void addRow(Adverbio p) {
